...
export default function Register() {
  ...
  return (
    ...
    >
      <div className="w-full max-w-md bg-white/40 dark:bg-gray-800/40 backdrop-blur-md p-6 rounded-lg shadow-md">
        {" "}
        <h1 className="text-2xl font-bold text-center text-blue-700 mb-6">
          Register New Account
        </h1>
        {isSuccess && (
          <div className="p-2 mb-4 text-sm text-blue-700 bg-green-100 rounded-lg text-center">
        ...
        <form onSubmit={formik.handleSubmit}>
          ...
          <button
            ...
            className="w-full bg-blue-600 mt-5 text-white py-2 rounded-lg hover:bg-blue-700"
          >
